    ...
    try:
        ...
        if "dimensions" in tasks:
            try:
                ...
                results["tasks"]["dimensions"] = {"error": str(e)}
        ...
        if "phashes" in tasks:
            try:
                ...
                results["tasks"]["phashes"] = {"error": str(e)}
        ...
        if "dominant_colors" in tasks:
            try:
                ...
                results["tasks"]["dominant_colors"] = {"error": str(e)}
        ...
        if "entropy" in tasks:
            try:
                ...
                results["tasks"]["entropy"] = {"error": str(e)}
        ...
        if "fft_frequency" in tasks:
            try:
                ...
                results["tasks"]["fft_frequency"] = {"error": str(e)}
        ...
        if "chi_square" in tasks:
            try:
                ...
                results["tasks"]["chi_square"] = {"error": str(e)}
        ...
        if "bitplane_slice" in tasks:
            try:
                ...
                results["tasks"]["bitplane_slice"] = {"error": str(e)}
        ...
        if "pixel_diff" in tasks:
            try:
                ...
                results["tasks"]["pixel_diff"] = {"error": str(e)}
        ...
        if "ghost" in tasks:
            try:
                ...
                results["tasks"]["ghost"] = {"error": str(e)}
        ...
        if "copymove" in tasks:
            try:
                ...
                results["tasks"]["copymove"] = {"error": str(e)}
        ...
        if "crop" in tasks:
            try:
                ...
                results["tasks"]["crop"] = {"error": str(e)}
        ...
        if "pixel_at_xy" in tasks:
            try:
                ...
                results["tasks"]["pixel_at_xy"] = {"error": str(e)}
